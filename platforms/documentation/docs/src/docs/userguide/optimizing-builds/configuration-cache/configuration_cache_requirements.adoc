...
Any state or behavior added by the custom type — extra fields, overridden methods — is silently lost.

To avoid the problem, do not reference a custom collection or map subtype from task fields or task actions.
